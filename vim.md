...
在home目录下新建一个 .vimrc , 在vimrc目录下新建bundle文件夹，插件都安装这里面
...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "# Author: LEEYANGY") 
        call append(line(".")+2, "# mail: 1787294587@qq.com") 
...
```bash
# git clone xxx 默认安装在/.vim/bundle/vundle下
...
3. 不在Github上的插件 对于不同的插件，vundle自动管理和下载插件的时候，有不同的地址填写方法，有如下三类：
...
修改 /etc/vimrc 或 ~/.vimrc，在文件最后添加以下内容： “ 当新建 .h .c .hpp .cpp .mk .sh等文件时自动调用SetTitle 函数 autocmd BufNewFile *.[ch],*.hpp,*.cpp,Makefile,*.mk,*.sh exec “:call SetTitle()” “ 加入注释 func SetComment() call setline(1,”/*================================================================”)
...
func SetComment()
        ...
        call append(line(".")+3, "*   创 建 者：LEEYANGY, 1787294587@qq.com")
...
func SetComment_sh()
        ...
        call setline(7, "#   创 建 者：LEEYANGY, 1787294587@qq.com")
...
```bash
wget https://codeload.github.com/vim/vim/tar.gz/refs/tags/v9.1.0407 && tar xf v9.1.0407 && cd v9.1.0407
```
